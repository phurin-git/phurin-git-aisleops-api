...
let InventoryController = class InventoryController {
  ...
  overview(search = "", stockStatus = "all") {
  ...
  movements(productCode = "", limit = 50) {
...
__decorate(
  [
    ...
    __param(1, (0, common_1.Query)("stockStatus")),
...
__decorate(
  [
    ...
    __param(
      ...
      (0, common_1.Query)(
        "limit",
        new common_1.ParseIntPipe({ optional: true }),
      ),
    ),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
